...
// Display size of M5Stick Core Grey = 320x240
...
#define TEXT_BUFFER_HEIGHT_MAX 15
...
// 3 = Button left
// 4 = Button below
// Display size of M5Stick Core Grey = 320x240pixel
// With TEXT_HEIGHT=16, the screen can display:
//   15 rows of text in landscape mode
//   20 rows of text in portrait mode
// =============================================================
void tb_display_init(int ScreenRotation){
  ...
  switch (ScreenRotation) {
    case 1: case 3: {
      ...
      // width of the screen in landscape mode is 320 pixel
    ...
    case 2: case 4: {
      ...
      text_buffer_height = 20;
      text_buffer_line_length = 30;
      // width of the screen in portrait mode is 240 pixel
      // A small margin on the right side prevent false print results
